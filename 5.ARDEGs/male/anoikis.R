rm(list = ls()) 
setwd("C:/Users/Administrator/Desktop/ischemic stroke & cell death/5.ARDEGs/male")
...
pdf(file="Fig5A.vol.pdf", width=7, height=6.1)
print(p)
dev.off()
...
pdf(file="Fig5B.heatmap.pdf", width=8, height=6)
...
pdf(file="Fig5C.RCircos.pdf", width=7, height=7)
...
GO=read.table("C:/Users/Administrator/Desktop/ischemic stroke & cell death/1.download & merge/male.GO.txt", header=T, sep="\t", check.names=F)
...
pdf(file="Fig5D.anoikis-related TOP8 GO term.pdf", width=7, height=5)
...
pdf(file="Fig5E.immun-cor.pdf", width=7, height=5)
