rm(list = ls()) 
setwd("C:/Users/Administrator/Desktop/ischemic stroke & cell death/3.FRDEGs/female")
...
pdf("Fig3K.GO.circlize.pdf",width=10,height=10)
...
pdf(file="Fig3G.vol.pdf", width=7, height=6.1)
print(p)
dev.off()
...
pdf(file="Fig3H.boxplot.pdf", width=7, height=5)
print(p1)
dev.off()
...
pdf("Fig3J.co-expression network among differential ferr-genes.pdf", width=7, height=6)
...
pdf(file="Fig3I.RCircos.pdf", width=7, height=7)
...
pdf(file="Fig3L.immun-cor.pdf", width=7, height=5)
