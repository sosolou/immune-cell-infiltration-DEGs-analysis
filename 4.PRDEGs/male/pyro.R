rm(list = ls()) 
setwd("C:/Users/Administrator/Desktop/ischemic stroke & cell death/4.PRDEGs/male")
...
pdf("Fig4E.GO.circlize.pdf",width=10,height=10)
...
pdf(file="Fig4A.vol.pdf", width=7, height=6.1)
print(p)
dev.off()
...
pdf(file="Fig4B.boxplot.pdf", width=7, height=5)
print(p1)
dev.off()
...
pdf("Fig4D.co-expression network among differential pyro-genes.pdf", width=7, height=6)
...
pdf(file="Fig4F.immun-cor.pdf", width=7, height=5)
